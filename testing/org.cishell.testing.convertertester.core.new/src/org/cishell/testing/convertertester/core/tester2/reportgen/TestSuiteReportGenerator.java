...
//
//			int testStep = Math
//					.max(1, testResults.length / this.testSampleSize);
//
...
//				int filePassStep = Math.max(1, fprs.length
//						/ this.filePassSampleSize);
//
...
//						report.println("Failed on "
//								+ fprFailure.getFailedConverter());
