...
CIShell algorithms are a generic concept which have many uses. \comments{flesh
out\ldots}
...
\begin{itemize}
  ...
  provide a \class{MetaTypeProvider} through its AlgorithmFactory's
...
\begin{itemize}
  ...
  \class{AlgorithmFactory}'s createParameters method will never be called and
  the \class{Dictionary} passed to the createAlgorithm method will always be
  empty.
\end{itemize}
