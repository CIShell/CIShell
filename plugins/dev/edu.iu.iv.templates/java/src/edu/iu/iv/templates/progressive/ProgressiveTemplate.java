...
/**
 * This class creates the TemplateSection for the Progressive IVC Algorithm Wizard.
 ...
 * as the AbstractPlugin implementor and the ProgressiveAlgorithm implementor in the case
 * of the Progressive Algorithm template.
 *
 * @author Team IVC
 */
public class ProgressiveTemplate extends OptionTemplateSection {
   
    //main page title
	private static final String PAGE_TITLE = "IVC Progressive Algorithm Plug-in";
	...
	/**
	 * Creates a new ProgressiveTemplate.
	 */
	public ProgressiveTemplate() {
	    //3 pages
		setPageCount(3);
	 ...
	 * 
	 * @return the unique name of this section, "progressive", which is where the
