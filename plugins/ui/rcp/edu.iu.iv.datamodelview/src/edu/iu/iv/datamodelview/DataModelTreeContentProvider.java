 ...
 * @author Team IVC
 */
public class DataModelTreeContentProvider implements ITreeContentProvider {
    ...
    public Object[] getChildren(Object parentElement) {
        if (parentElement instanceof DataModelGUIItem) {
            return ((DataModelGUIItem) parentElement).getChildren();
        }
    ...
    public Object getParent(Object element) {
        if (element instanceof DataModelGUIItem) {
            return ((DataModelGUIItem) element).getParent();
        }
