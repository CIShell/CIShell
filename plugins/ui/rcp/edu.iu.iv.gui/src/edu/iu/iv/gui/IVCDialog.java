...
/**
 * This class provides a DialogBox structure that can be extended to create Dialogs for IVC.
 * This framework will enforce consistency in the look and feel of Dialogs in IVC by providing a
 ...
 * @author Team IVC
 */
public abstract class IVCDialog extends Dialog {
    ...
    /**
     * Creates a new IVCDialog object.
     *
     * @param parent the parent Shell of this IVCDialog
     * @param title the title to put in the title bar of this IVCDialog
     * @param image the Image to display to the left of the description specified
     *        for this IVCDialog. This will usually be one of:
     * <ul>
     * <li>IVCDialog.WARNING</li>
     * <li>IVCDialog.INFORMATION</li>
     * <li>IVCDialog.ERROR</li>
     * <li>IVCDialog.WORKING</li>
     * <li>IVCDialog.QUESTION</li>
     * </ul>
     */
    public IVCDialog(Shell parent, String title, Image image) {
        super(parent, 0);
        setText(title);
        this.image = image;
        this.parent = parent;
    ...
    /**
     * Returns the shell used by this IVCDialog
     * 
     * @return the shell used by this IVCDialog
     */
    ...
    /**
     * Initializes this IVCDialog. This consists of resetting all of the
    ...
    /**
     * Opens this IVCDialog.
     * 
     * @return true if this IVCDialog was closed by clicking the 'x' in the upper right
    ...
    /**
     * Sets the Description of this IVCDialog.  This is the text that is displayed in the
     ...
     *
     * @param description the description for this IVCDialog to use
     */
    ...
    /**
     * Sets the details text of this IVCDialog.  This is the text that is displayed in the lower
    ...
    /**
     * Creates the Buttons to use in this IVCDialog based on the given parent. These are
     ...
     * 
     * @param parent the parent to be used to create the Buttons for this IVCDialog
     */
    public abstract void createDialogButtons(Composite parent);

    /**
     * Creates the content section of this IVCDialog based on the given parent.
     * This section is where all of the "guts" of the IVCDialog go, specifying the controls
     * that are needed to interact with the user and provide whatever questions or information
     * are needed.
     *
     * @param parent the parent to be used to create the Buttosn for this IVCDialog
     *
     * @return the Composite that is created to display the content of this IVCDialog
     */
    ...
    private static boolean openOKDialog(Shell parent, Image image, String title, String message, String details){
        IVCDialog okDialog = new IVCDialog(parent, title, image){
    ...
    private static boolean openConfirmDenyDialog(Shell parent, Image image, String title, String message, String details, final String confirmLabel, final String denyLabel){
        IVCDialog dialog = new IVCDialog(parent, title, image){
            public void createDialogButtons(Composite parent) {
