...
/**
 * ContentProvider for the DataModel TreeView. This class is used to form the
 * structure of the tree that is displayed based on the relationships between
...
public class DataTreeContentProvider implements ITreeContentProvider {
	 ...
	 * 
	 * @param parentElement
	 *            the TreeView element to find the children of
	 * 
	...
	/**
	 * Gets the parent of the given TreeView element. This element should be a
	 * WorkflowTreeITem
	 * 
	 * @param element
	 *            the element to find the parent of
	 * 
	 ...
	 * 
	 * @param element
	 *            the TreeView element to find the children for.
	 * 
	 ...
	 * 
	 * @param inputElement
	 *            the root element of the TreeViewer
	 * 
	 ...
	 * Does nothing.
	 * 
	 * This method could be used to notify this content provider that the given
	 * viewer's input has been switched to a different element.
	 * 
	 * @param viewer
	 *            the viewer
	 * @param oldInput
