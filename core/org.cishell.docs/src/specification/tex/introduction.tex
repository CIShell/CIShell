...
academic journals. An \class{Algorithm} with a capital A refers the Java class
...
CIShell Platform. This includes the implementation of \class{AlgorithmFactory}
and \class{Algorithm}, and the metadata, files, and other code that go into an
OSGi bundle.
