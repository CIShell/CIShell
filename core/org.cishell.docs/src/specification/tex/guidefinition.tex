...
\class{MetaTypeProvider} is an interface defined in the OSGi R4 Specification
...
called an \class{ObjectClassDefinition}, which provides a UI name and description
